...
Same pipeline as run_accuracy_original.py, but using the densified (0.1 m step)
topo-intersection and geological-map-boundary shapefiles
(`3D_Topo_Intersections_rsmpl_0.1.shp`, `Limiti_CartaGeol_rsmpl_0.1.shp`).
See ../GeoSurface_Accuracy_custom/CONTEXT.md for the full explanation of how
this dataset maps onto THEORY.md, and for what differs between the two runs.
...
MAPS_FILE = "Limiti_CartaGeol_rsmpl_0.1.shp"
TOPO_FILE = "3D_Topo_Intersections_rsmpl_0.1.shp"
